%% 读入图像并进行预处理：
clear;clc;
test1 = im2double(imread('test1.pgm'));
test2 = im2double(imread('test2.tif'));
p1_Butterworth=Butterworth(test1,200,5);
p1_Gaussian=Gaussian(test1,100);
p2_Butterworth=Butterworth(test2,200,5);
p2_Gaussian=Gaussian(test2,100);
